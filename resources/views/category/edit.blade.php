    ...
    <form action="/categories/category/store" method="POST">
        ...
        <div class="p-4 mb-2"><h1>Редактирование категории</h1>
            <div class="form-group"><label for="inputDesription" class="col-xs-2 control-label">Введите описание(desription)</label>
                <div class="col-xs-10">
                    <input type="text" name="desription" class="form-control" placeholder="введите описание" id="desription" value="{{$categories->desription}}"></div
        ...
        <div> <label for="inputKeywords" class="col-xs-2 control-label">Введите keywords</label>
            <div class="col-xs-10">
                <input type="text" name="keywords" placeholder="введите ключевые слова" id="inputKeywords" value="{{$categories->keywords}}">
        ...
        <div> <div class="form-group"><label for="inputtitle" class="col-xs-2 control-label">Введите заголовок</label>
                <div class="col-xs-10">
                    <input type="text" name="title" placeholder="введите заголовок" id="title" value="{{$categories->title}}"></div>
        ...
        <div><div class="form-group"><label for="inputslug" class="col-xs-2 control-label">Введите урл страницы</label>
                <div class="col-xs-10">
                    <input type="text" name="slug" placeholder="Укажите slug" value="{{$categories->slug}}"></div>
        ...
        <div><div class="form-group"><label for="inputtextl" class="col-xs-2 control-label">Введите описание категории</label>
                <div class="col-xs-10">
                    <textarea rows="10" cols="45" name="text" placeholder="введите пост статьи">{{$categories->text}}</textarea></div>
